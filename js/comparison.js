const GENRE_COLORS = {
  "Drama":"#E4B85C","Comedy":"#D98C3F","Crime":"#8E79B8","Sci-Fi":"#6F8FA8",
  "Horror":"#B84A5A","Romance":"#D86A73","Adventure":"#7DBA8C","Action":"#C76E3D",
  "Animation":"#F2D27A","Fantasy":"#6FAE9F","Short":"#9A9A9A","Documentary":"#A8B07A",
  "Thriller":"#7A6AAE","Mystery":"#5F7E9E","Family":"#CDBF9A","Music":"#D6A1C7",
  "War":"#A67C52","Western":"#B8945E","History":"#B8AA8A","Biography":"#A6A86F",
  "Sport":"#9A9A9A","Musical":"#D6A1C7","Other":"#606060",
};
